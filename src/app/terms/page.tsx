            ...
            <div className="w-full max-w-md bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm space-y-6 text-center">
                ...
                <div className="space-y-4">
                    <button
                        ...
                        className="w-full py-4 bg-white border border-zinc-300 text-zinc-900 rounded-xl font-bold hover:bg-zinc-50 transition shadow-sm flex items-center justify-center gap-2 disabled:opacity-70 cursor-pointer"
                    >
                        Googleでログイン
                    </button>
                    ...
                    <div className="pt-6 border-t border-zinc-100 dark:border-zinc-800">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                ...
                                className="py-3 px-2 bg-zinc-50 border border-zinc-200 text-zinc-600 rounded-xl text-[11px] font-bold hover:bg-zinc-100 hover:text-zinc-900 transition shadow-sm dark:bg-zinc-800/50 dark:border-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-200 cursor-pointer"
                            >
                                一般ユーザー
                            </button>
                            <button
