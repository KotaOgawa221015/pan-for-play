    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        <header className="flex items-center justify-between border-b pb-4 dark:border-zinc-800">
          ...
          <Link href="/" className="text-sm text-zinc-500 hover:underline">ボードへ戻る</Link>
        </header>
        ...
        <main className="grid gap-4 md:grid-cols-2">
          ...
          >
            ...
            <h2 className="font-semibold text-lg text-zinc-900 dark:text-zinc-100">納品書読み込み</h2>
            <p className="text-xs text-zinc-400 mt-1">画像をアップロードして在庫を一括更新します</p>
          </Link>
