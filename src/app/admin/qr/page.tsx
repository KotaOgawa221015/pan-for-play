...
export default function QRPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 px-6 py-8 dark:bg-zinc-950 print:bg-white print:p-0">
      <div className="mx-auto flex max-w-sm flex-col gap-6 rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 print:border-none print:shadow-none print:p-0">
