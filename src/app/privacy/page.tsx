    ...
    return (
        <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 p-8 text-zinc-800 dark:text-zinc-200">
            <div className="max-w-2xl mx-auto space-y-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm">
                <h1 className="text-2xl font-bold border-b border-zinc-200 dark:border-zinc-800 pb-4">プライバシーポリシー</h1>
                ...
                <section className="space-y-3">
                    ...
                    <ul className="list-disc pl-5 text-sm space-y-1">
                        <li>Googleアカウントから提供されるプロフィール情報（氏名、メールアドレス、プロフィール画像）</li>
                        <li>本サービス内での操作ログ（在庫ステータスの変更履歴、納品書のアップロード履歴等）</li>
                    </ul>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <ul className="list-disc pl-5 text-sm space-y-1">
                        ...
                        <li>在庫管理ボードにおける「最終変更者」の表示およびトレーサビリティ（監査ログ）の確保</li>
                ...
                <section className="space-y-3">
                    <h2 className="text-lg font-semibold">4. データの保持と削除（退会）</h2>
                    <p className="text-sm leading-relaxed">
