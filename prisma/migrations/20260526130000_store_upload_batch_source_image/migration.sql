...
CREATE TABLE "new_UploadBatch" (
    ...
    "sourceImageBytes" BLOB,
    "sourceImageMimeType" TEXT,
...
INSERT INTO "new_UploadBatch" ("createdAt", "fridgeId", "id", "originalFileName", "processedAt", "deletedAt", "updatedAt", "uploadedByUserId") SELECT "createdAt", "fridgeId", "id", "originalFileName", "processedAt", "deletedAt", "updatedAt", "uploadedByUserId" FROM "UploadBatch";
