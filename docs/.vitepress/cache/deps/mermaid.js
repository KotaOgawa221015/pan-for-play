...
import { registerLayoutLoaders } from './chunk-IROEDOXO.js';
...
import { dedent, registerIconPacks } from './chunk-5PGEKNL7.js';
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
import { __name, log, select_default, setLogLevel } from './chunk-XXDMU5XJ.js';
      ...
      case 0:
        ...
        switch (character2) {
          ...
          case 59 + offset:
            ...
            if (
              property > 0 &&
              (strlen(characters2) - length2 || variable === 0)
            )
              append(
                property > 32
                  ? declaration(
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import(
    './c4Diagram-AAUBKEIU-QUC5MNKC.js'
  );
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './flowDiagram-I6XJVG4X-3Q6LFAT6.js'
  );
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './erDiagram-TEJ5UH35-Z5MLVO2A.js'
  );
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './gitGraphDiagram-PVQCEYII-23AL65NQ.js'
  );
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './ganttDiagram-6RSMTGT7-ATMMANTH.js'
  );
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './infoDiagram-5YYISTIA-GFBN6P5G.js'
  );
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './pieDiagram-4H26LBE5-6JILYLBW.js'
  );
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './quadrantDiagram-W4KKPZXB-LYGEHVDL.js'
  );
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './xychartDiagram-2RQKCTM6-WP3CCZBK.js'
  );
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './requirementDiagram-4Y6WPE33-QSMIPMXS.js'
  );
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './sequenceDiagram-3UESZ5HK-TBJKCWML.js'
  );
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './classDiagram-4FO5ZUOK-WJGOA6Q4.js'
  );
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './classDiagram-v2-Q7XG4LA2-WW4QKBJT.js'
  );
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './stateDiagram-AJRCARHV-4TJ25RWS.js'
  );
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './stateDiagram-v2-BHNVJYJU-3CTA3L7C.js'
  );
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './journeyDiagram-JHISSGLW-LWEFXIFY.js'
  );
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './timeline-definition-PNZ67QCA-NDEAK7P4.js'
  );
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './mindmap-definition-RKZ34NQL-5HZMI36P.js'
  );
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './kanban-definition-UN3LZRKU-PY2VSZ7V.js'
  );
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './sankeyDiagram-5OEKKPKP-JNQPQMM5.js'
  );
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './blockDiagram-GPEHLZMM-IQWELCA3.js'
  );
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './architectureDiagram-3BPJPVTR-3NQZMZJC.js'
  );
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './ishikawaDiagram-YF4QCWOH-WUGGA7EX.js'
  );
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './vennDiagram-CIIHVFJN-QQ72MDJM.js'
  );
...
var loader32 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './wardleyDiagram-YWT4CUSO-YGPDG2DQ.js'
  );
...
var loadRegisteredDiagrams = __name(async () => {
  ...
  const results = await Promise.allSettled(
    Object.entries(detectors).map(
      async ([key, { detector: detector33, loader: loader33 }]) => {
        if (!loader33) {
          return;
        }
        try {
...
var cssImportantStyles = __name((cssClass, element, cssClasses = []) => {
  const declarationBlock = sanitizeCss(
    `{ ${cssClasses.join(' !important; ')} !important; }`,
  );
...
var appendDivSvgG = __name(
  (parentRoot, id33, enclosingDivId, divStyle, svgXlink) => {
...
var render = __name(async (id33, text, svgContainingElement) => {
...
var initialize2 = __name((config) => {
  mermaidAPI.initialize(config);
}, 'initialize');
var init = __name(async (config, nodes, callback) => {
...
var setParseErrorHandler = __name((parseErrorHandler) => {
