import { drawRect, getNoteRect } from './chunk-GK34SFUZ.js';
import {
  calculateTextHeight,
  calculateTextWidth,
  wrapLabel,
...
var c4Type;
var getC4Type = __name(() => c4Type, 'getC4Type');
var setC4Type = __name((c4TypeParam) => {
...
var addPersonOrSystem = __name(
  (typeC4Shape, alias, label, descr, sprite, tags, link) => {
...
var addContainer = __name(
  (typeC4Shape, alias, label, techn, descr, sprite, tags, link) => {
    if (alias === null || label === null) {
      return;
    }
    let container = {};
...
var addPersonOrSystemBoundary = __name((alias, label, type, tags, link) => {
  if (alias === null || label === null) {
    return;
  }
  let boundary = {};
...
var addContainerBoundary = __name((alias, label, type, tags, link) => {
  if (alias === null || label === null) {
    return;
  }
  let boundary = {};
...
var addDeploymentNode = __name(
  (nodeType, alias, label, type, descr, sprite, tags, link) => {
    if (alias === null || label === null) {
      return;
    }
    let boundary = {};
...
var popBoundaryParseStack = __name(() => {
  currentBoundaryParse = parentBoundaryParse;
  boundaryParseStack.pop();
  parentBoundaryParse = boundaryParseStack.pop();
  boundaryParseStack.push(parentBoundaryParse);
}, 'popBoundaryParseStack');
var updateElStyle = __name(
  (
    typeC4Shape,
    elementName,
    bgColor,
...
var updateRelStyle = __name(
  (typeC4Shape, from, to, textColor, lineColor, offsetX, offsetY) => {
...
var updateLayoutConfig = __name(
  (typeC4Shape, c4ShapeInRowParam, c4BoundaryInRowParam) => {
...
var getC4ShapeInRow = __name(() => c4ShapeInRow, 'getC4ShapeInRow');
var getC4BoundaryInRow = __name(() => c4BoundaryInRow, 'getC4BoundaryInRow');
var getCurrentBoundaryParse = __name(
  () => currentBoundaryParse,
  'getCurrentBoundaryParse',
);
var getParentBoundaryParse = __name(
  () => parentBoundaryParse,
  'getParentBoundaryParse',
);
var getC4ShapeArray = __name((parentBoundary) => {
...
var getC4Shape = __name(
  (alias) =>
    c4ShapeArray.find((personOrSystem) => personOrSystem.alias === alias),
  'getC4Shape',
);
var getC4ShapeKeys = __name(
  (parentBoundary) => Object.keys(getC4ShapeArray(parentBoundary)),
  'getC4ShapeKeys',
);
var getBoundaries = __name((parentBoundary) => {
  if (parentBoundary === void 0 || parentBoundary === null) {
    return boundaries;
  } else {
...
var getRels = __name(() => rels, 'getRels');
var getTitle = __name(() => title, 'getTitle');
var setWrap = __name((wrapSetting) => {
  wrapEnabled = wrapSetting;
}, 'setWrap');
var autoWrap = __name(() => wrapEnabled, 'autoWrap');
var clear = __name(() => {
  c4ShapeArray = [];
  boundaries = [
    {
...
var drawRect2 = __name(
  (elem, rectData) => drawRect(elem, rectData),
  'drawRect',
);
var drawImage = __name((elem, width, height, x, y, link) => {
...
var drawBoundary = __name((elem, boundary, conf2) => {
...
var drawC4Shape = __name((elem, c4Shape, conf2) => {
  var _a3;
...
var insertArrowEnd = __name((elem, id) => {
  elem
    .append('defs')
    .append('marker')
    .attr('id', id + '-arrowend')
...
function calcC4ShapeTextWH(
  ...
  if (!c4Shape[textType].width) {
    if (c4ShapeTextWrap) {
      ...
      const lines = c4Shape[textType].text.split(common_default.lineBreakRegex);
...
var drawBoundary2 = __name((diagram2, boundary, bounds) => {
...
var drawC4ShapeArray = __name(
  (currentBounds, diagram2, c4ShapeArray2, c4ShapeKeys) => {
    let Y = 0;
...
var Point =
  ...
  __name(_a2, 'Point'),
  _a2);
var getIntersectPoint = __name((fromNode, endPoint) => {
  const x1 = fromNode.x;
  const y1 = fromNode.y;
  const x2 = endPoint.x;
  const y2 = endPoint.y;
...
var getIntersectPoints = __name((fromNode, endNode) => {
...
var drawRels2 = __name((diagram2, rels2, getC4ShapeObj, diagObj, diagramId) => {
  let i = 0;
  for (const rel of rels2) {
    i = i + 1;
...
function drawInsideBoundary(
  ...
  for (const [i, currentBoundary] of currentBoundaries.entries()) {
    ...
    const currentPersonOrSystemArray = diagObj.db.getC4ShapeArray(
      currentBoundary.alias,
    );
    const currentPersonOrSystemKeys = diagObj.db.getC4ShapeKeys(
      currentBoundary.alias,
    );
    ...
    const nextCurrentBoundaries = diagObj.db.getBoundaries(parentBoundaryAlias);
...
var draw = __name((_text, id, _version, diagObj) => {
  ...
  const currentBoundaries = diagObj.db.getBoundaries('');
...
export { diagram };
//# sourceMappingURL=c4Diagram-AAUBKEIU-QUC5MNKC.js.map
