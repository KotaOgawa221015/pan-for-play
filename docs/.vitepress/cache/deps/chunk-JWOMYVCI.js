...
import { createLabel_default } from './chunk-KPKCQMCT.js';
import { isLabelStyle, styles2String } from './chunk-DAFQSPID.js';
import { getSubGraphTitleMargins } from './chunk-XISVJL4A.js';
import { at } from './chunk-B7KO5YQV.js';
import { createText } from './chunk-5PGEKNL7.js';
import { handleUndefinedAttr, utils_default } from './chunk-OEGWB26X.js';
import {
  getConfig,
  getConfig2,
...
var addEdgeMarker = __name(
  (
    ...
    const marginSupport =
      arrowTypeInfo && arrowTypesWithMarginSupport.includes(arrowTypeInfo.type);
    if (!arrowTypeInfo) {
...
var findAdjacentPoint = __name((pointA, pointB, distance) => {
...
var fixCorners = __name((lineData) => {
...
var insertEdge = __name(
  (
    ...
    const useMargin =
      !animatedEdge && (edge == null ? void 0 : edge.look) === 'neo';
    addEdgeMarkers(
      svgPath,
      edge,
      url,
...
//# sourceMappingURL=chunk-JWOMYVCI.js.map
