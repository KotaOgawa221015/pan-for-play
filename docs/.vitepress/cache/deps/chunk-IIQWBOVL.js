import { __export, __name, log, setLogLevel } from './chunk-XXDMU5XJ.js';
...
var Channel = {
  ...
  toLinear: (c) => {
    const n = c / 255;
    return c > 0.03928 ? ((n + 0.055) / 1.055) ** 2.4 : n / 12.92;
  },
...
function createDOMPurify() {
  ...
  const DocumentFragment = window2.DocumentFragment,
  ...
  const _sanitizeAttachedShadowRoots2 = function _sanitizeAttachedShadowRoots(
    ...
    if (
      ...
      root.shadowRoot instanceof DocumentFragment
    ) {
...
var UnknownDiagramError =
  ...
  _a);
var detectors = {};
var detectType = __name((text2, config2) => {
  text2 = text2
...
var Theme =
  ((_a2 = class {
    ...
    updateColors() {
      ...
      this.radar = {
        axisColor:
          ((_a14 = this.radar) == null ? void 0 : _a14.axisColor) ||
          this.lineColor,
        axisStrokeWidth:
      ...
      this.wardley = {
        backgroundColor:
          ((_k = this.wardley) == null ? void 0 : _k.backgroundColor) ||
          this.background,
        axisColor:
          ((_l = this.wardley) == null ? void 0 : _l.axisColor) ||
          this.lineColor,
        axisTextColor:
          ((_m = this.wardley) == null ? void 0 : _m.axisTextColor) ||
          this.primaryTextColor,
        gridColor:
          ((_n = this.wardley) == null ? void 0 : _n.gridColor) ||
          this.gridColor,
        componentFill:
          ((_o = this.wardley) == null ? void 0 : _o.componentFill) ||
          this.background,
        componentStroke:
          ((_p = this.wardley) == null ? void 0 : _p.componentStroke) ||
          this.lineColor,
        componentLabelColor:
          ((_q = this.wardley) == null ? void 0 : _q.componentLabelColor) ||
          this.primaryTextColor,
        linkStroke:
          ((_r = this.wardley) == null ? void 0 : _r.linkStroke) ||
          this.lineColor,
        evolutionStroke:
          ((_s = this.wardley) == null ? void 0 : _s.evolutionStroke) ||
          this.wardleyEvolutionColor,
        annotationStroke:
          ((_t = this.wardley) == null ? void 0 : _t.annotationStroke) ||
          this.lineColor,
        annotationTextColor:
          ((_u = this.wardley) == null ? void 0 : _u.annotationTextColor) ||
          this.primaryTextColor,
        annotationFill:
          ((_v = this.wardley) == null ? void 0 : _v.annotationFill) ||
          this.background,
      };
      ...
      this.xyChart = {
        backgroundColor:
          ((_w = this.xyChart) == null ? void 0 : _w.backgroundColor) ||
          this.background,
        titleColor:
          ((_x = this.xyChart) == null ? void 0 : _x.titleColor) ||
          this.primaryTextColor,
        dataLabelColor:
          ((_y = this.xyChart) == null ? void 0 : _y.dataLabelColor) ||
          this.primaryTextColor,
        xAxisTitleColor:
          ((_z = this.xyChart) == null ? void 0 : _z.xAxisTitleColor) ||
          this.primaryTextColor,
        xAxisLabelColor:
          ((_A = this.xyChart) == null ? void 0 : _A.xAxisLabelColor) ||
          this.primaryTextColor,
        xAxisTickColor:
          ((_B = this.xyChart) == null ? void 0 : _B.xAxisTickColor) ||
          this.primaryTextColor,
        xAxisLineColor:
          ((_C = this.xyChart) == null ? void 0 : _C.xAxisLineColor) ||
          this.primaryTextColor,
        yAxisTitleColor:
          ((_D = this.xyChart) == null ? void 0 : _D.yAxisTitleColor) ||
          this.primaryTextColor,
        yAxisLabelColor:
          ((_E = this.xyChart) == null ? void 0 : _E.yAxisLabelColor) ||
          this.primaryTextColor,
        yAxisTickColor:
          ((_F = this.xyChart) == null ? void 0 : _F.yAxisTickColor) ||
          this.primaryTextColor,
        yAxisLineColor:
          ((_G = this.xyChart) == null ? void 0 : _G.yAxisLineColor) ||
          this.primaryTextColor,
        plotColorPalette:
...
var Theme2 =
  ((_a3 = class {
    ...
    updateColors() {
      ...
      this.xyChart = {
        backgroundColor:
          ((_a14 = this.xyChart) == null ? void 0 : _a14.backgroundColor) ||
          this.background,
        titleColor:
          ((_b = this.xyChart) == null ? void 0 : _b.titleColor) ||
          this.primaryTextColor,
        dataLabelColor:
          ((_c = this.xyChart) == null ? void 0 : _c.dataLabelColor) ||
          this.primaryTextColor,
        xAxisTitleColor:
          ((_d = this.xyChart) == null ? void 0 : _d.xAxisTitleColor) ||
          this.primaryTextColor,
        xAxisLabelColor:
          ((_e = this.xyChart) == null ? void 0 : _e.xAxisLabelColor) ||
          this.primaryTextColor,
        xAxisTickColor:
          ((_f = this.xyChart) == null ? void 0 : _f.xAxisTickColor) ||
          this.primaryTextColor,
        xAxisLineColor:
          ((_g = this.xyChart) == null ? void 0 : _g.xAxisLineColor) ||
          this.primaryTextColor,
        yAxisTitleColor:
          ((_h = this.xyChart) == null ? void 0 : _h.yAxisTitleColor) ||
          this.primaryTextColor,
        yAxisLabelColor:
          ((_i = this.xyChart) == null ? void 0 : _i.yAxisLabelColor) ||
          this.primaryTextColor,
        yAxisTickColor:
          ((_j = this.xyChart) == null ? void 0 : _j.yAxisTickColor) ||
          this.primaryTextColor,
        yAxisLineColor:
          ((_k = this.xyChart) == null ? void 0 : _k.yAxisLineColor) ||
          this.primaryTextColor,
        plotColorPalette:
      ...
      this.radar = {
        axisColor:
          ((_m = this.radar) == null ? void 0 : _m.axisColor) || this.lineColor,
        axisStrokeWidth:
          ((_n = this.radar) == null ? void 0 : _n.axisStrokeWidth) || 2,
        axisLabelFontSize:
          ((_o = this.radar) == null ? void 0 : _o.axisLabelFontSize) || 12,
        curveOpacity:
          ((_p = this.radar) == null ? void 0 : _p.curveOpacity) || 0.5,
        curveStrokeWidth:
          ((_q = this.radar) == null ? void 0 : _q.curveStrokeWidth) || 2,
        graticuleColor:
          ((_r = this.radar) == null ? void 0 : _r.graticuleColor) || '#DEDEDE',
        graticuleStrokeWidth:
          ((_s = this.radar) == null ? void 0 : _s.graticuleStrokeWidth) || 1,
        graticuleOpacity:
          ((_t = this.radar) == null ? void 0 : _t.graticuleOpacity) || 0.3,
        legendBoxSize:
          ((_u = this.radar) == null ? void 0 : _u.legendBoxSize) || 12,
        legendFontSize:
          ((_v = this.radar) == null ? void 0 : _v.legendFontSize) || 12,
      };
      this.wardleyEvolutionColor = this.wardleyEvolutionColor || '#ff6b6b';
      this.wardley = {
        backgroundColor:
          ((_w = this.wardley) == null ? void 0 : _w.backgroundColor) ||
          this.background,
        axisColor:
          ((_x = this.wardley) == null ? void 0 : _x.axisColor) ||
          this.lineColor,
        axisTextColor:
          ((_y = this.wardley) == null ? void 0 : _y.axisTextColor) ||
          this.primaryTextColor,
        gridColor:
          ((_z = this.wardley) == null ? void 0 : _z.gridColor) ||
          this.gridColor,
        componentFill:
          ((_A = this.wardley) == null ? void 0 : _A.componentFill) ||
          this.mainBkg,
        componentStroke:
          ((_B = this.wardley) == null ? void 0 : _B.componentStroke) ||
          this.lineColor,
        componentLabelColor:
          ((_C = this.wardley) == null ? void 0 : _C.componentLabelColor) ||
          this.primaryTextColor,
        linkStroke:
          ((_D = this.wardley) == null ? void 0 : _D.linkStroke) ||
          this.lineColor,
        evolutionStroke:
          ((_E = this.wardley) == null ? void 0 : _E.evolutionStroke) ||
          this.wardleyEvolutionColor,
        annotationStroke:
          ((_F = this.wardley) == null ? void 0 : _F.annotationStroke) ||
          this.lineColor,
        annotationTextColor:
          ((_G = this.wardley) == null ? void 0 : _G.annotationTextColor) ||
          this.primaryTextColor,
        annotationFill:
          ((_H = this.wardley) == null ? void 0 : _H.annotationFill) ||
          this.mainBkg,
      };
      ...
      this.emProcessorFill =
        this.emProcessorFill || lighten_default('#5a3d5c', 10);
      this.emProcessorStroke = this.emProcessorStroke || '#8a6d8c';
      this.emReadModelFill =
        this.emReadModelFill || lighten_default('#3d5a2d', 10);
...
var Theme6 =
  ((_a7 = class {
    ...
    updateColors() {
      ...
      this.activeTaskBkgColor =
        this.activeTaskBkgColor || lighten_default(primaryColor, 23);
      this.gridColor = this.gridColor || 'lightgrey';
      this.doneTaskBkgColor = this.doneTaskBkgColor || 'lightgrey';
      this.doneTaskBorderColor = this.doneTaskBorderColor || 'grey';
      this.critBorderColor = this.critBorderColor || '#ff8888';
      ...
      this.cScale8 =
        this.cScale8 || adjust_default(primaryColor, { h: 210, l: 150 });
      ...
      this.fillType2 =
        this.fillType2 || adjust_default(primaryColor, { h: 64 });
      this.fillType3 =
        this.fillType3 || adjust_default(secondaryColor, { h: 64 });
      this.fillType4 =
        this.fillType4 || adjust_default(primaryColor, { h: -64 });
      this.fillType5 =
        this.fillType5 || adjust_default(secondaryColor, { h: -64 });
      this.fillType6 =
        this.fillType6 || adjust_default(primaryColor, { h: 128 });
      this.fillType7 =
        this.fillType7 || adjust_default(secondaryColor, { h: 128 });
      ...
      this.pie10 =
        this.pie10 || adjust_default(primaryColor, { h: 60, l: -20 });
      this.pie11 =
        this.pie11 || adjust_default(primaryColor, { h: -60, l: -20 });
      this.pie12 =
        this.pie12 || adjust_default(primaryColor, { h: 120, l: -10 });
      this.pieTitleTextSize = this.pieTitleTextSize || '25px';
      this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor;
      this.pieSectionTextSize = this.pieSectionTextSize || '17px';
      this.pieSectionTextColor = this.pieSectionTextColor || this.textColor;
      ...
      this.quadrant2Fill =
        this.quadrant2Fill ||
        adjust_default(primaryColor, { r: 5, g: 5, b: 5 });
      this.quadrant3Fill =
        this.quadrant3Fill ||
        adjust_default(primaryColor, { r: 10, g: 10, b: 10 });
      this.quadrant4Fill =
        this.quadrant4Fill ||
        adjust_default(primaryColor, { r: 15, g: 15, b: 15 });
      this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor;
      this.quadrant2TextFill =
        this.quadrant2TextFill ||
        adjust_default(this.primaryTextColor, { r: -5, g: -5, b: -5 });
    ...
    if (typeof args[key] === 'object') {
      if (key === 'nodeColors') {
        ...
        for (const colorKey of Object.keys(args[key])) {
          if (
            typeof args[key][colorKey] !== 'string' ||
            !colorPattern.test(args[key][colorKey])
          ) {
            log.debug(
              'sanitize deleting invalid color:',
              colorKey,
              args[key][colorKey],
            );
...
var getEffectiveHtmlLabels = __name((config2) => {
  var _a14, _b;
  if (
    ((_a14 = config2.flowchart) == null ? void 0 : _a14.htmlLabels) != void 0
  ) {
...
var getMax = __name((...values) => {
  const newValues = values.filter((value) => {
    return !isNaN(value);
  });
  return Math.max(...newValues);
}, 'getMax');
var getMin = __name((...values) => {
  const newValues = values.filter((value) => {
    return !isNaN(value);
  });
  return Math.min(...newValues);
}, 'getMin');
var parseGenericTypes = __name((input) => {
...
var hasKatex = __name((text2) => {
  var _a14;
  return (
    (((_a14 = text2.match(katexRegex)) == null ? void 0 : _a14.length) ?? 0) > 0
  );
}, 'hasKatex');
...
var renderKatexUnsanitized = __name(async (text2, config2) => {
  ...
  if (true) {
    const { default: katex } = await import('./katex-D3HXBFE2.js');
    const outputMode =
...
var d3Attrs = __name((d3Elem, attrs) => {
  for (const attr of attrs) {
    d3Elem.attr(attr[0], attr[1]);
  }
}, 'd3Attrs');
var calculateSvgSizeAttrs = __name((height, width, useMaxWidth) => {
...
var configureSvgSize = __name((svgElem, height, width, useMaxWidth) => {
  const attrs = calculateSvgSizeAttrs(height, width, useMaxWidth);
  d3Attrs(svgElem, attrs);
}, 'configureSvgSize');
var setupGraphViewbox = __name((graph, svgElem, padding, useMaxWidth) => {
...
*/
//# sourceMappingURL=chunk-IIQWBOVL.js.map
