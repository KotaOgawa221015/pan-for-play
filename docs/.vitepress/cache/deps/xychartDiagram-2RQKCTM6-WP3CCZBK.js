...
import { computeDimensionOfText } from './chunk-5PGEKNL7.js';
...
import { __name, band, line_default, linear, log } from './chunk-XXDMU5XJ.js';
      ...
      case 'rect':
        ...
        if (chartConfig.showDataLabel) {
          ...
          if (chartConfig.chartOrientation === 'horizontal') {
            const fitsHorizontally2 = (item, fontSize) => {
            ...
            const fitsInBar2 = (item, fontSize, yOffset2) => {
              const { data, label } = item;
              const charWidthFactor = 0.7;
              const textWidth = fontSize * label.length * charWidthFactor;
            ...
            shapeGroup
              ...
              .attr(
                'dominant-baseline',
                showDataLabelOutsideBar ? 'auto' : 'hanging',
              )
              .attr('fill', themeConfig.dataLabelColor)
              .attr('font-size', `${uniformFontSize}px`)
              .text((item) => item.label);
...
export { diagram };
//# sourceMappingURL=xychartDiagram-2RQKCTM6-WP3CCZBK.js.map
