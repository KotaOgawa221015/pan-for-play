...
// node_modules/.pnpm/katex@0.16.46/node_modules/katex/dist/katex.mjs
...
var path = {
  ...
  leftlinesegment: doubleBrushStroke(
...
var stretchySvg = function stretchySvg2(group, options) {
  function buildSvgSpan_() {
    ...
    if (wideAccentLabels.has(label) && 'base' in group) {
      var numChars =
        group.base.type === 'ordgroup' ? group.base.body.length : 1;
      var viewBoxHeight;
      var pathName;
      var _height;
      if (numChars > 5) {
...
defineFunction({
  ...
  mathmlBuilder(group, options) {
    return new MathNode(
      'mrow',
      buildExpression2(group.body, options.withFont('')),
    );
  },
});
defineFunction({
  ...
  htmlBuilder(group, options) {
    ...
    if (subm) {
      ...
      if (base instanceof SymbolNode || isOiint) {
        var _base$italic;
        marginLeft = makeEm(
          -((_base$italic = base.italic) != null ? _base$italic : 0),
        );
      }
    }
    var supsub;
...
var Namespace = class {
  ...
  has(name) {
    return (
      Object.hasOwn(this.current, name) || Object.hasOwn(this.builtins, name)
    );
  }
  /**
...
var Parser = class _Parser {
  ...
  parseGroup(name, breakOnTokenText) {
    ...
    if (text2 === '{' || text2 === '\\begingroup') {
      ...
      if (
        result == null &&
        text2[0] === '\\' &&
        !Object.hasOwn(implicitCommands, text2)
      ) {
  ...
  parseSymbol() {
    ...
    if (
      Object.hasOwn(unicodeSymbols, text2[0]) &&
...
//# sourceMappingURL=katex-D3HXBFE2.js.map
