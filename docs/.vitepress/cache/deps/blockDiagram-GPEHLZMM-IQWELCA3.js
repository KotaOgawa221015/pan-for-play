    ...
    performAction: __name(function anonymous(
      ...
      switch (yystate) {
        ...
        case 23: {
          ...
          const startEdgeData = yy.edgeStrToEdgeStartData(
            $$[$0 - 1].edgeTypeStr,
          );
...
var addStyleClass = __name((id, styleAttributes = '') => {
...
var addStyle2Node = __name((id, styles = '') => {
  const foundBlock = blockDatabase.get(id);
  if (styles !== void 0 && styles !== null) {
    foundBlock.styles = styles.split(STYLECLASS_SEP);
  }
}, 'addStyle2Node');
var setCssClass = __name((itemIds, cssClassName) => {
...
var getClasses = __name(() => classes, 'getClasses');
var db = {
...
function layoutBlocks(block, db2) {
  ...
  if (
    ...
    let startingPosX = (
      (_g = block == null ? void 0 : block.size) == null
        ? void 0
        : _g.x
    )
      ? ((_h = block == null ? void 0 : block.size) == null ? void 0 : _h.x) +
    ...
    for (const child of block.children) {
      ...
      if (py != rowPos) {
        rowPos = py;
        startingPosX = (
          (_j = block == null ? void 0 : block.size) == null
            ? void 0
            : _j.x
        )
...
var insertEdge = __name((elem, e, edge, clusterDb, diagramType, graph, id) => {
...
var note = __name(async (parent, node) => {
  ...
  node.intersect = (point2) => intersect_default.rect(node, point2);
  return shapeSvg;
}, 'note');
...
var choice = __name((parent, node) => {
  ...
  node.width = 28;
  node.height = 28;
  node.intersect = (point2) => intersect_default.circle(node, 14, point2);
  return shapeSvg;
}, 'choice');
var hexagon = __name(async (parent, node) => {
  ...
  node.intersect = (point2) => intersect_default.polygon(node, points, point2);
  return shapeSvg;
}, 'hexagon');
var block_arrow = __name(async (parent, node) => {
  ...
  const isSpanning =
    node.positioned && (node.widthInColumns ?? 1) > 1 && node.width > naturalW;
...
var start = __name((parent, node) => {
  ...
  circle3
    ...
    .attr('height', 14);
  updateNodeBounds(node, circle3);
  node.intersect = (point2) => intersect_default.circle(node, 7, point2);
  return shapeSvg;
}, 'start');
...
var getClasses2 = __name(
  (text, diagObj) => diagObj.db.getClasses(),
  'getClasses',
);
...
export { diagram };
//# sourceMappingURL=blockDiagram-GPEHLZMM-IQWELCA3.js.map
