...
var require_cose_base = __commonJS({
  'node_modules/.pnpm/cose-base@1.0.3/node_modules/cose-base/cose-base.js'(
    ...
    })(exports, (__WEBPACK_EXTERNAL_MODULE_0__) =>
      /******/
      ((modules) => {
        var installedModules = {};
        function __webpack_require__(moduleId) {
          ...
          CoSELayout.prototype.groupZeroDegreeMembers = function () {
            ...
            Object.keys(tempMemberGroups).forEach((p_id2) => {
              if (tempMemberGroups[p_id2].length > 1) {
                ...
                this.memberGroups[dummyCompoundId] = tempMemberGroups[p_id2];
        ...
        (module2, exports2, __webpack_require__) => {
          ...
          _CoSELayout.prototype.run = function () {
            ...
            var iterateAnimated = function iterateAnimated2() {
              ...
              options.eles.nodes().positions((ele, i3) => {
                if (typeof ele === 'number') {
                  ele = i3;
                }
                if (!ele.isParent()) {
            ...
            layout.addListener('layoutstarted', () => {
          ...
          _CoSELayout.prototype.getTopMostNodes = (nodes) => {
            var nodesMap = {};
            for (var i = 0; i < nodes.length; i++) {
...
function createCytoscapeInstance(data) {
  return new Promise((resolve) => {
    ...
    const layoutConfig = {
      name: 'cose-bilkent',
      // @ts-expect-error Types for cose-bilkent are not correct?
      quality: 'proof',
      styleEnabled: false,
      animate: false,
    };
...
//# sourceMappingURL=cose-bilkent-S5V4N54A-B2HLDSXL.js.map
