...
function compileStyleAliases(map2) {
  var result = {};
  if (map2 !== null) {
    Object.keys(map2).forEach((style) => {
      map2[style].forEach((alias) => {
...
var str = new type('tag:yaml.org,2002:str', {
  kind: 'scalar',
  construct: __name((data) => (data !== null ? data : ''), 'construct'),
});
...
var _null = new type('tag:yaml.org,2002:null', {
  ...
  predicate: isNull,
  represent: {
    canonical: __name(() => '~', 'canonical'),
    lowercase: __name(() => 'null', 'lowercase'),
    uppercase: __name(() => 'NULL', 'uppercase'),
    camelcase: __name(() => 'Null', 'camelcase'),
    empty: __name(() => '', 'empty'),
  },
...
var bool = new type('tag:yaml.org,2002:bool', {
  ...
  predicate: isBoolean,
  represent: {
    lowercase: __name((object) => (object ? 'true' : 'false'), 'lowercase'),
    uppercase: __name((object) => (object ? 'TRUE' : 'FALSE'), 'uppercase'),
    camelcase: __name((object) => (object ? 'True' : 'False'), 'camelcase'),
  },
  defaultStyle: 'lowercase',
});
...
var int = new type('tag:yaml.org,2002:int', {
  ...
  represent: {
    ...
    decimal: __name((obj) => obj.toString(10), 'decimal'),
...
mermaid/dist/chunks/mermaid.core/chunk-XPW4576I.mjs:
  ...
  *)
*/
//# sourceMappingURL=chunk-3GNSFRHJ.js.map
