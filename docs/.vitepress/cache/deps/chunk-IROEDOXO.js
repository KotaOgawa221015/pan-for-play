...
import { insertCluster, insertNode, labelHelper } from './chunk-KPKCQMCT.js';
import { interpolateToCurve } from './chunk-OEGWB26X.js';
import { common_default, getConfig } from './chunk-IIQWBOVL.js';
  ...
  registerLayoutLoaders([
    {
      name: 'dagre',
      loader: __name(
        async () => await import('./dagre-BM42HDAG-KG2OETC2.js'),
        'loader',
      ),
    },
    ...(true
      ? [
          {
            name: 'cose-bilkent',
            loader: __name(
              async () => await import('./cose-bilkent-S5V4N54A-B2HLDSXL.js'),
              'loader',
            ),
          },
        ]
...
//# sourceMappingURL=chunk-IROEDOXO.js.map
