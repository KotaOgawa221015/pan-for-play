...
import { __export, __name, log, select_default } from './chunk-XXDMU5XJ.js';
...
var genColor = __name((options) => {
  ...
  const hasBkgColors =
    (bkgColorArray == null ? void 0 : bkgColorArray.length) > 0;
  let sections = '';
...
export { diagram };
//# sourceMappingURL=erDiagram-TEJ5UH35-Z5MLVO2A.js.map
