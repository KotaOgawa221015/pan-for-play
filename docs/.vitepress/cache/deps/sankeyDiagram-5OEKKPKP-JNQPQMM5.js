...
var draw = __name((text, id, _version, diagObj) => {
  ...
  const nodeWidth =
    (conf == null ? void 0 : conf.nodeWidth) ??
    defaultSankeyConfig.nodeWidth ??
    10;
  const nodePadding =
    (conf == null ? void 0 : conf.nodePadding) ??
    defaultSankeyConfig.nodePadding ??
    12;
  const labelStyle =
    (conf == null ? void 0 : conf.labelStyle) ??
    defaultSankeyConfig.labelStyle ??
    'legacy';
...
export { diagram };
//# sourceMappingURL=sankeyDiagram-5OEKKPKP-JNQPQMM5.js.map
