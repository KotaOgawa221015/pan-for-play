...
function a(t2) {
  const e2 = t2[0],
    s2 = t2[1];
  return Math.sqrt((e2[0] - s2[0]) ** 2 + (e2[1] - s2[1]) ** 2);
}
    ...
    switch (c2) {
      ...
      case 'A': {
        ...
        if (0 === t3 || 0 === s3)
          ...
          x(n2, o2, i3, c3, t3, s3, a3, h3, r3).forEach((t4) => {
...
var P = {
  randOffset: (t2, e2) => G(t2, e2),
  randOffsetWithRange: (t2, e2, s2) => E(t2, e2, s2),
  ellipse: (t2, e2, s2, n2, o2) => {
    const a2 = T(s2, n2, o2);
    return D(t2, e2, o2, a2).opset;
  },
  doubleLineOps: (t2, e2, s2, n2, o2) => $(t2, e2, s2, n2, o2, true),
};
...
function T(t2, e2, s2) {
  const n2 = Math.sqrt(
      2 * Math.PI * Math.sqrt(((t2 / 2) ** 2 + (e2 / 2) ** 2) / 2),
    ),
    o2 = Math.ceil(
