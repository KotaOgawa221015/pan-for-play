...
import { __name, arc_default, select_default } from './chunk-XXDMU5XJ.js';
...
var addTask = __name((descr, taskData) => {
...
var getActors = __name(() => updateActors(), 'getActors');
...
var drawText2 = __name(
  (elem, textData) => drawText(elem, textData),
  'drawText',
);
...
var drawSection = __name((elem, section, conf2) => {
...
var taskCount = -1;
var drawTask = __name((elem, task, conf2, diagramId) => {
...
var drawTasks = __name((diagram2, tasks2, verticalPos, diagramId) => {
  const conf2 = getConfig2().journey;
  let lastSection = '';
...
export { diagram };
//# sourceMappingURL=journeyDiagram-JHISSGLW-LWEFXIFY.js.map
