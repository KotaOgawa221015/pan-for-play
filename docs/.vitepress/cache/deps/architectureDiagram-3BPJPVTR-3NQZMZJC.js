import { populateCommonDb } from './chunk-TKK63NIN.js';
import { parse } from './chunk-BIZKQYMA.js';
...
import { cytoscape as cytoscape2 } from './chunk-UWLM5C7B.js';
import './chunk-S6KOWPKD.js';
import './chunk-UVTR36U7.js';
import './chunk-7MUBAYHL.js';
import { selectSvgElement } from './chunk-IWLICCHX.js';
import {
  createText,
  getIconSVG,
  registerIconPacks,
  unknownIcon,
} from './chunk-5PGEKNL7.js';
import { cleanAndMerge, getEdgeId } from './chunk-OEGWB26X.js';
import './chunk-WVHZLITH.js';
import {
  clear,
...
import { __name, log, select_default } from './chunk-XXDMU5XJ.js';
  ...
  'node_modules/.pnpm/layout-base@2.0.1/node_modules/layout-base/layout-base.js'(
    ...
    (function webpackUniversalModuleDefinition(root, factory) {
      ...
      ((modules) => {
        ...
        __webpack_require__.i = (value) => value;
        __webpack_require__.d = (exports2, name, getter) => {
        ...
        (module2, exports2, __webpack_require__) => {
          ...
          LNode.prototype.getEdgeListToNode = function (to) {
            ...
            this.edges.forEach((edge2) => {
              if (edge2.target == to) {
                if (edge2.source != this) throw 'Incorrect edge source!';
                edgeList.push(edge2);
              }
            });
            return edgeList;
          ...
          LNode.prototype.getEdgesBetween = function (other) {
            ...
            var edge;
            this.edges.forEach((edge2) => {
              if (!(edge2.source == this || edge2.target == this))
            ...
            while (queue.length !== 0) {
              ...
              for (var i = 0; i < size; i++) {
                ...
                if (currentNeighbor != null && !visited.has(currentNeighbor)) {
                  ...
                  childrenOfNeighbor.forEach((node) => {
                    queue.push(node);
                    visited.add(node);
                  });
                }
        ...
        (module2, exports2, __webpack_require__) => {
          ...
          LGraphManager.prototype.isOneAncestorOfOther = (
            firstNode,
            secondNode,
          ) => {
          ...
          LGraphManager.prototype.calcLowestCommonAncestor = (
            firstNode,
            secondNode,
          ) => {
            if (firstNode == secondNode) {
        ...
        (module2, exports2, __webpack_require__) => {
          ...
          IGeometry.getCardinalDirection = (slope, slopePrime, line) => {
            if (slope > slopePrime) {
              return line;
            } else {
              return 1 + (line % 4);
          ...
          IGeometry.doIntersect = (p1, p2, p3, p4) => {
            var a = p1.x;
            var b = p1.y;
            var c = p2.x;
            var d = p2.y;
          ...
          IGeometry.findCircleLineIntersections = (
            Ex,
            Ey,
            Lx,
            Ly,
        ...
        (module2, exports2, __webpack_require__) => {
          ...
          UniqueIDGeneretor.createID = (obj) => {
          ...
          UniqueIDGeneretor.getString = (id) => {
            if (id == null) id = UniqueIDGeneretor.lastID;
            return 'Object#' + id;
          };
          UniqueIDGeneretor.isPrimitive = (arg) => {
        ...
        (module2, exports2, __webpack_require__) => {
          ...
          Layout2.prototype.newEdge = (vEdge) => new LEdge(null, null, vEdge);
          ...
          Layout2.transform = (sliderValue, defaultValue, minDiv, maxMul) => {
          ...
          Layout2.findCenterOfTree = (nodes) => {
            var list = [];
        ...
        (module2, exports2, __webpack_require__) => {
          ...
          FDLayout.prototype.calcRepulsionRange = () => 0;
        ...
        (module2, exports2, __webpack_require__) => {
          ...
          Matrix.multCons = (array, constant) => {
            var result = [];
          ...
          Matrix.dotProduct = (array1, array2) => {
            var product = 0;
            for (var i = 0; i < array1.length; i++) {
        ...
        (module2, exports2, __webpack_require__) => {
          ...
          SVD.svd = function (A) {
            ...
            for (var k = 0; k < Math.max(nct, nrt); k++) {
              ...
              if (/* @__PURE__ */ ((lhs, rhs) => lhs && rhs)(wantu, k < nct)) {
                    ...
                    for (var _j6 = p - 2; _j6 >= _k3; _j6--) {
                      ...
                      if (wantv) {
                        for (var _i20 = 0; _i20 < this.n; _i20++) {
                          ...
                          this.V[_i20][p - 1] =
                            -sn * this.V[_i20][_j6] + cs * this.V[_i20][p - 1];
                          this.V[_i20][_j6] = _t5;
                        }
                      }
                    }
...
var require_cose_base = __commonJS({
  'node_modules/.pnpm/cose-base@2.2.0/node_modules/cose-base/cose-base.js'(
    ...
    })(exports, (__WEBPACK_EXTERNAL_MODULE__551__) =>
      /******/
      (() => {
        var __webpack_modules__ = {
          ...
          765:
            ...
            (module2, __unused_webpack_exports, __webpack_require__2) => {
              ...
              CoSELayout.prototype.newEdge = (vEdge) =>
                new CoSEEdge(null, null, vEdge);
              ...
              CoSELayout.prototype.classicLayout = function () {
                ...
                if (!this.incremental) {
                  ...
                  if (forest.length > 0) {
                    ...
                    var intersection = this.nodesWithGravity.filter((x) =>
                      allNodes.has(x),
                    );
                    this.graphManager.setAllNodesToApplyGravitation(
                      intersection,
              ...
              CoSELayout.prototype.initConstraintVariables = function () {
                ...
                var calculateCompoundWeight = function calculateCompoundWeight2(
                  compoundNode,
                ) {
                ...
                if (this.constraints.fixedNodeConstraint) {
                  this.constraints.fixedNodeConstraint.forEach((nodeData2) => {
                ...
                if (this.constraints.relativePlacementConstraint) {
                  ...
                  this.fixedNodeSet.forEach((nodeId) => {
                  ...
                  if (this.constraints.alignmentConstraint) {
                    if (this.constraints.alignmentConstraint.vertical) {
                      ...
                      for (var i = 0; i < verticalAlignment.length; i++) {
                        ...
                        verticalAlignment[i].forEach((nodeId) => {
                    ...
                    if (this.constraints.alignmentConstraint.horizontal) {
                      ...
                      for (var i = 0; i < horizontalAlignment.length; i++) {
                        ...
                        horizontalAlignment[i].forEach((nodeId) => {
              ...
              CoSELayout.prototype.updateDisplacements = function () {
                if (this.constraints.fixedNodeConstraint) {
                  this.constraints.fixedNodeConstraint.forEach((nodeData2) => {
                    var fixedNode = this.idToNodeMap.get(nodeData2.nodeId);
                ...
                if (this.constraints.relativePlacementConstraint) {
                  if (CoSEConstants.RELAX_MOVEMENT_ON_CONSTRAINTS) {
                    ...
                    this.nodesInRelativeHorizontal.forEach((nodeId) => {
                      if (!this.fixedNodesOnHorizontal.has(nodeId)) {
                        var displacement = 0;
                        if (this.dummyToNodeForVerticalAlignment.has(nodeId)) {
                          displacement = this.idToNodeMap.get(
                            this.dummyToNodeForVerticalAlignment.get(nodeId)[0],
                          ).displacementX;
                        } else {
                          displacement =
                            this.idToNodeMap.get(nodeId).displacementX;
                        }
                        this.nodeToRelativeConstraintMapHorizontal
                          .get(nodeId)
                          .forEach((constraint) => {
                            if (constraint.right) {
                              var diff =
                                this.nodeToTempPositionMapHorizontal.get(
                                  constraint.right,
                                ) -
                                this.nodeToTempPositionMapHorizontal.get(
                                  nodeId,
                        ...
                        this.nodeToTempPositionMapHorizontal.set(
                          nodeId,
                          this.nodeToTempPositionMapHorizontal.get(nodeId) +
                            displacement,
                        );
                        if (this.dummyToNodeForVerticalAlignment.has(nodeId)) {
                          this.dummyToNodeForVerticalAlignment
                            .get(nodeId)
                            .forEach((nodeId2) => {
                              this.idToNodeMap.get(nodeId2).displacementX =
                                displacement;
                            });
                        } else {
                          this.idToNodeMap.get(nodeId).displacementX =
                    ...
                    this.nodesInRelativeVertical.forEach((nodeId) => {
                      if (!this.fixedNodesOnHorizontal.has(nodeId)) {
                        var displacement = 0;
                        if (
                          this.dummyToNodeForHorizontalAlignment.has(nodeId)
                        ) {
                          displacement = this.idToNodeMap.get(
                          ...
                          displacement =
                            this.idToNodeMap.get(nodeId).displacementY;
                        }
                        this.nodeToRelativeConstraintMapVertical
                          .get(nodeId)
                          .forEach((constraint) => {
                            if (constraint.bottom) {
                              var diff =
                                this.nodeToTempPositionMapVertical.get(
                                  constraint.bottom,
                                ) -
                                this.nodeToTempPositionMapVertical.get(nodeId) -
                                displacement;
                              if (diff < constraint.gap) {
                                displacement -= constraint.gap - diff;
                              }
                        ...
                        this.nodeToTempPositionMapVertical.set(
                          nodeId,
                          this.nodeToTempPositionMapVertical.get(nodeId) +
                            displacement,
                        );
                        if (
                          ...
                          this.dummyToNodeForHorizontalAlignment
                            .get(nodeId)
                            .forEach((nodeId2) => {
                              this.idToNodeMap.get(nodeId2).displacementY =
                                displacement;
                            });
                        } else {
                          this.idToNodeMap.get(nodeId).displacementY =
                        ...
                        for (var j = 0; j < component.length; j++) {
                          if (
                            ...
                            this.dummyToNodeForVerticalAlignment
                              .get(component[j])
                              .forEach((nodeId) => {
                                this.idToNodeMap.get(nodeId).displacementX = 0;
                              });
                          } else {
                        ...
                        for (var j = 0; j < component.length; j++) {
                          if (
                            ...
                            this.dummyToNodeForHorizontalAlignment
                              .get(component[j])
                              .forEach((nodeId) => {
                                this.idToNodeMap.get(nodeId).displacementY = 0;
                              });
                          } else {
              ...
              CoSELayout.maxDiagonalInTree = (tree) => {
              ...
              CoSELayout.prototype.groupZeroDegreeMembers = function () {
                ...
                Object.keys(tempMemberGroups).forEach((p_id2) => {
                  if (tempMemberGroups[p_id2].length > 1) {
                    ...
                    var dummyParentGraph = this.getGraphManager().add(
                      this.newGraph(),
                      dummyCompound,
                    );
              ...
              CoSELayout.prototype.clearZeroDegreeMembers = function () {
                ...
                Object.keys(this.memberGroups).forEach((id) => {
                  var compoundNode = this.idToDummyNode[id];
                  tiledZeroDegreePack[id] = this.tileNodes(
                    this.memberGroups[id],
              ...
              CoSELayout.prototype.repopulateZeroDegreeMembers = function () {
                ...
                Object.keys(tiledPack).forEach((id) => {
                  var compoundNode = this.idToDummyNode[id];
              ...
              CoSELayout.prototype.getNodeDegree = (node) => {
                var id = node.id;
              ...
              CoSELayout.prototype.adjustLocations = (
                organization,
                x,
                y,
              ...
              CoSELayout.prototype.tileCompoundMembers = function (
                ...
                Object.keys(childGraphMap).forEach((id) => {
                  var compoundNode = idToNode[id];
                  this.tiledMemberPack[id] = this.tileNodes(
                    childGraphMap[id],
                    compoundNode.paddingLeft + compoundNode.paddingRight,
                  );
                  compoundNode.rect.width = this.tiledMemberPack[id].width;
                  compoundNode.rect.height = this.tiledMemberPack[id].height;
                  compoundNode.setCenter(
                    this.tiledMemberPack[id].centerX,
                    this.tiledMemberPack[id].centerY,
                  );
                  compoundNode.labelMarginLeft = 0;
                  compoundNode.labelMarginTop = 0;
                  if (CoSEConstants.NODE_DIMENSIONS_INCLUDE_LABELS) {
              ...
              CoSELayout.prototype.getOrgRatio = (organization) => {
              ...
              CoSELayout.prototype.calcIdealRowWidth = (
                members,
                favorHorizontalDim,
              ) => {
                ...
                var delta =
                  (verticalPadding - horizontalPadding) ** 2 +
                  4 *
              ...
              CoSELayout.prototype.insertNodeToRow = (
                organization,
                node,
                rowIndex,
                minWidth,
              ...
              CoSELayout.prototype.getShortestRowIndex = (organization) => {
                var r = -1;
              ...
              CoSELayout.prototype.getLongestRowIndex = (organization) => {
                var r = -1;
          ...
          991:
            ...
            (module2, __unused_webpack_exports, __webpack_require__2) => {
              ...
              CoSENode.prototype.getPred1 = () => pred1;
              CoSENode.prototype.getPred2 = () => pred2;
              CoSENode.prototype.setNext = function (next2) {
                this.next = next2;
              };
              CoSENode.prototype.getNext = () => next;
              CoSENode.prototype.setProcessed = function (processed2) {
                this.processed = processed2;
              };
              CoSENode.prototype.isProcessed = () => processed;
              ...
              ConstraintHandler.handleConstraints = (layout) => {
                          ...
                          if (fixedNodes2 && fixedNodes2.has(neighbor.id)) {
                            ...
                            if (
                              ...
                              var diff =
                                ...
                                neighbor.gap -
                                fixedPosition;
                              pastMap.get(currentNode).forEach((nodeId) => {
                                positionMap.set(
                                  nodeId,
                      ...
                      pastMap.forEach((value, key) => {
                        if (sinkNodes.has(key)) {
                          ...
                          if (!isFixedComponent) {
                            var isExist = false;
                            var existAt = void 0;
                            _components.forEach((component, index2) => {
                              if (
                                component.has(
                ...
                var applyReflectionForRelativePlacement =
                  function applyReflectionForRelativePlacement2(
                    ...
                    var reflectOnX = 0,
                      notReflectOnX = 0;
                    relativePlacementConstraints.forEach((constraint) => {
                      if (constraint.left) {
                ...
                if (constraints.fixedNodeConstraint) {
                  constraints.fixedNodeConstraint.forEach((nodeData2) => {
                ...
                if (CoSEConstants.TRANSFORM_ON_CONSTRAINT_HANDLING) {
                  if (
                    ...
                    constraints.fixedNodeConstraint.forEach((nodeData2, i2) => {
                      targetMatrix[i2] = [
                    ...
                    (() => {
                      ...
                      if (constraints.alignmentConstraint.vertical) {
                        ...
                        var _loop2 = function _loop22(_i42) {
                          ...
                          verticalAlign[_i42].forEach((nodeId) => {
                            alignmentSet.add(nodeId);
                          });
                          var intersection = new Set(
                            []
                              .concat(_toConsumableArray(alignmentSet))
                              .filter((x) => fixedNodes.has(x)),
                          );
                          var xPos = void 0;
                      ...
                      if (constraints.alignmentConstraint.horizontal) {
                        ...
                        var _loop3 = function _loop32(_i52) {
                          var alignmentSet = /* @__PURE__ */ new Set();
                          horizontalAlign[_i52].forEach((nodeId) => {
                            alignmentSet.add(nodeId);
                          });
                          var intersection = new Set(
                            []
                    ...
                    if (largestComponentSize < dagUndirected.size / 2) {
                      ...
                      components[largestComponentIndex].forEach((nodeId) => {
                        dag.get(nodeId).forEach((adjacent) => {
                ...
                if (CoSEConstants.ENFORCE_CONSTRAINTS) {
                  if (
                    ...
                    translationAmount.y /=
                      constraints.fixedNodeConstraint.length;
                    xCoords.forEach((value, i2) => {
                      xCoords[i2] += translationAmount.x;
                    });
                    yCoords.forEach((value, i2) => {
                  ...
                  if (constraints.relativePlacementConstraint) {
                    (() => {
                      ...
                      if (constraints.alignmentConstraint) {
                        if (constraints.alignmentConstraint.vertical) {
                          ...
                          var _loop6 = function _loop62(_i112) {
                            ...
                            verticalAlignment[_i112].forEach((nodeId2) => {
                              nodeToDummyForVerticalAlignment.set(
                                nodeId2,
                                'dummy' + _i112,
                              );
                        ...
                        if (constraints.alignmentConstraint.horizontal) {
                          ...
                          var _loop7 = function _loop72(_i122) {
                            ...
                            horizontalAlignment[_i122].forEach((nodeId2) => {
                              nodeToDummyForHorizontalAlignment.set(
                                nodeId2,
                                'dummy' + _i122,
                              );
                      ...
                      var _loop8 = function _loop82(nodeId2) {
                        dag.get(nodeId2).forEach((adjacent) => {
                          var sourceId = void 0;
                      ...
                      componentsOnHorizontal.forEach((component, index2) => {
                        componentSourcesOnHorizontal[index2] = [];
                        component.forEach((nodeId2) => {
                          if (
                      ...
                      componentsOnVertical.forEach((component, index2) => {
...
var require_cytoscape_fcose = __commonJS({
  'node_modules/.pnpm/cytoscape-fcose@2.2.0_cytoscape@3.33.3/node_modules/cytoscape-fcose/cytoscape-fcose.js'(
    ...
    })(exports, (__WEBPACK_EXTERNAL_MODULE__140__) =>
      /******/
      (() => {
        var __webpack_modules__ = {
          /***/
          ...
          548:
            ...
            (module2, __unused_webpack_exports, __webpack_require__2) => {
              ...
              var auxiliary = {};
              auxiliary.getTopMostNodes = (nodes) => {
                var nodesMap = {};
                for (var i = 0; i < nodes.length; i++) {
                  nodesMap[nodes[i].id()] = true;
                }
                var roots = nodes.filter((ele, i2) => {
              ...
              auxiliary.connectComponents = (
                ...
                var _loop = function _loop2() {
                  ...
                  childrenOfCurrentNode.forEach((node) => {
                    queue.push(node);
                    visited.add(node);
                    cmpt.merge(node);
                  });
                  ...
                  cmpt.forEach((node) => {
                    eles.intersection(node.connectedEdges()).forEach((e) => {
              ...
              auxiliary.relocateComponent = (
                ...
                if (!options.fixedNodeConstraint) {
                  ...
                  if (options.quality == 'draft') {
                    ...
                    Object.keys(componentResult).forEach((item) => {
              ...
              auxiliary.calcParentsWithoutChildren = (cy, eles) => {
                    ...
                    value: function run() {
                      ...
                      if (eles.nodes().length > 0) {
                        if (!packingEnabled) {
                            ...
                            if (options.tile) {
                              ...
                              components.forEach((component, index) => {
                                if (component.edges().length == 0) {
                                  component.nodes().forEach((node, i2) => {
                          ...
                          if (components.length > 1) {
                            var subgraphs = [];
                            var hiddenEles = eles.filter(
                              (ele) => ele.css('display') == 'none',
                            );
                            components.forEach((component, index) => {
                            ...
                            if (options.quality == 'draft') {
                              spectralResult.forEach((result2, index) => {
                      ...
                      var getPositions = function getPositions2(ele, i2) {
                        if (
                          ...
                          var _pos = void 0;
                          spectralResult.forEach((result2) => {
                      ...
                      if (
                        ...
                        eles
                          ...
                          .not(':parent')
                          .not(_hiddenEles)
                          .layoutPositions(this, options, getPositions);
            ...
            (module2, __unused_webpack_exports, __webpack_require__2) => {
              ...
              var spectralLayout = function spectralLayout2(options) {
                ...
                parentNodes.forEach((ele) => {
                  ...
                  children.nodes(':childless').forEach((ele2, i2) => {
                ...
                var _loop = function _loop2(_key2) {
                  ...
                  dummyNodes.get(_key2).forEach((id) => {
                ...
                if (nodeSize > 2) {
                  ...
                  if (options.quality == 'draft' || options.step == 'all') {
                    ...
                    nodeIndexes.forEach((value, key2) => {
...
var getOppositeArchitectureDirection = __name((x) => {
...
var isArchitectureDirection = __name((x) => {
  const temp = x;
  return temp === 'L' || temp === 'R' || temp === 'T' || temp === 'B';
}, 'isArchitectureDirection');
var isArchitectureDirectionX = __name((x) => {
  const temp = x;
  return temp === 'L' || temp === 'R';
}, 'isArchitectureDirectionX');
var isArchitectureDirectionY = __name((x) => {
  const temp = x;
  return temp === 'T' || temp === 'B';
}, 'isArchitectureDirectionY');
var isArchitectureDirectionXY = __name((a, b) => {
  const aX_bY = isArchitectureDirectionX(a) && isArchitectureDirectionY(b);
  const aY_bX = isArchitectureDirectionY(a) && isArchitectureDirectionX(b);
  return aX_bY || aY_bX;
}, 'isArchitectureDirectionXY');
var isArchitecturePairXY = __name((pair) => {
  const lhs = pair[0];
  const rhs = pair[1];
...
var isValidArchitectureDirectionPair = __name(
  (x) => x !== 'LL' && x !== 'RR' && x !== 'TT' && x !== 'BB',
  'isValidArchitectureDirectionPair',
);
var getArchitectureDirectionPair = __name((sourceDir, targetDir) => {
  const pair = `${sourceDir}${targetDir}`;
  return isValidArchitectureDirectionPair(pair) ? pair : void 0;
}, 'getArchitectureDirectionPair');
var shiftPositionByArchitectureDirectionPair = __name(([x, y], pair) => {
  const lhs = pair[0];
  const rhs = pair[1];
...
var getArchitectureDirectionXYFactors = __name((pair) => {
  if (pair === 'LT' || pair === 'TL') {
    return [1, 1];
...
var getArchitectureDirectionAlignment = __name((a, b) => {
...
var isArchitectureService = __name((x) => {
  const temp = x;
  return temp.type === 'service';
}, 'isArchitectureService');
var isArchitectureJunction = __name((x) => {
  const temp = x;
...
var drawEdges = __name(async (edgesEl, cy, db, diagramId) => {
...
var drawGroups = __name(async (groupsEl, cy, db, diagramId) => {
  const padding = db.getConfigField('padding');
...
var drawServices = __name(async (db, elem, services, diagramId) => {
...
var drawJunctions = __name((db, elem, junctions, diagramId) => {
...
function layoutArchitecture(
  ...
  return new Promise((resolve) => {
      ...
      style: [
        ...
        },
        {
          ...
          style: {
            ...
            // @ts-expect-error Incorrect library types
    ...
    const iconSize = db.getConfigField('iconSize');
    const sameGroupIdealLength =
      db.getConfigField('idealEdgeLengthMultiplier') * iconSize;
    ...
    layout.one('layoutstop', () => {
      ...
      function getSegmentWeights(source, target, pointX, pointY) {
        ...
        D =
          ...
          Math.sqrt(1 + ((sY - tY) / (sX - tX)) ** 2);
        W = Math.sqrt((pointY - sY) ** 2 + (pointX - sX) ** 2 - D ** 2);
        const distAB = Math.sqrt((tX - sX) ** 2 + (tY - sY) ** 2);
        W = W / distAB;
...
export { diagram };
//# sourceMappingURL=architectureDiagram-3BPJPVTR-3NQZMZJC.js.map
