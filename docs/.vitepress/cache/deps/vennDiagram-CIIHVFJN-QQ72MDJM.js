...
import { __name, select_default } from './chunk-XXDMU5XJ.js';
...
var addSubsetData = __name((identifierList, label, size) => {
  ...
  const resolvedSize = size ?? 10 / identifierList.length ** 2;
  currentSets = sets;
  if (sets.length === 1) {
...
export { diagram };
//# sourceMappingURL=vennDiagram-CIIHVFJN-QQ72MDJM.js.map
