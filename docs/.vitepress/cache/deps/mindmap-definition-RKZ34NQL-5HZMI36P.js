  ...
  ((_a = class {
    ...
    flattenNodes(node, processedNodes) {
      ...
      const getShapeFromType = __name((type) => {
        var _a2;
        const theme =
          ((_a2 = conf.theme) == null ? void 0 : _a2.toLowerCase()) ?? '';
...
var genSections = __name((options) => {
  ...
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    const sw =
      '' + (look === 'neo' ? Math.max(10 - (i - 1) * 2, 2) : 17 - 3 * i);
    sections += `
...
var getStyles = __name((options) => {
  ...
  const scopedDropShadow = options.dropShadow
    ? options.dropShadow.replace(
        'url(#drop-shadow)',
        `url(${svgId}-drop-shadow)`,
      )
    : 'none';
  return `
  .edge {
...
export { diagram };
//# sourceMappingURL=mindmap-definition-RKZ34NQL-5HZMI36P.js.map
